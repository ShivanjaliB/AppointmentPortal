...
@Component({
  selector: 'app-personappointmentadd',
  templateUrl: './personappointmentadd.component.html',
  styleUrls: ['./personappointmentadd.component.scss']
})

export class PersonappointmentaddComponent implements OnInit {
  vehicleId: any
  tranp_name: any = ""
  number: any = ""
  vehicle_no: any = ""
 ...
 private dialogRef: MatDialogRef<PersonappointmentaddComponent>,
