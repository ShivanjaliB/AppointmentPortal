...
@Component({
  selector: 'app-vehicleappointmentlist',
  templateUrl: './vehicleappointmentlist.component.html',
  styleUrls: ['./vehicleappointmentlist.component.scss']
})
export class VehicleappointmentlistComponent implements OnInit {
...
console.log(result)
  ...
  openDialog(): void {
    const dialogRef = this.dialog.open(VehicleappointmentaddComponent, {
